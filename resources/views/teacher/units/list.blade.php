                    ...
                    @forelse($units as $unit)
                        <tr class="text-center">
                            ...
                            <td>
                                ...
                                <a class="btn btn-outline-danger delete-record" data-route="{{ route("teacher.units.destroy", ["unit" => $unit]) }}" href="#">
                        ...
                        <tr class="text-center">
                            <td colspan="7">
                                <div class="empty-results">
                                    {!! __("No tienes ninguna unidad todavía: :link", ["link" => "<a href='".route('teacher.units.create')."'>Crear mi primera unidad</a>"]) !!}
                                </div>
                            </td>
                        </tr>
                    @endforelse
